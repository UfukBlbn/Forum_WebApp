...
namespace BlazorForm.Api.Application.Features.Commands.User.Update
{
    public class UpdateUserCommandHandler : IRequestHandler<UpdateUserCommand, Guid>
    {
        ...
        public async Task<Guid> Handle(UpdateUserCommand request, CancellationToken cancellationToken)
        {
            ...
            if (emailChanged && rows > 0)
            {
                ...
                QueueFactory.SendMessageToExchange(exchangeName: ForumConstants.UserExchangeName,
                                                   exchangeType: ForumConstants.DefaultExchangeType,
                                                   queueName: ForumConstants.UserEmailChangedQueueName,
                                                   obj: @event);
            }
